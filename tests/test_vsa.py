...
def test_reversed_concat():
    ...
    assert not a_concat_b._model_vsa._reversed

    ra_concat_b = claripy.Concat(reversed_a, b)
    assert not ra_concat_b._model_vsa._reversed

    a_concat_rb = claripy.Concat(a, reversed_b)
    assert not a_concat_rb._model_vsa._reversed

    ra_concat_rb = claripy.Concat(reversed_a, reversed_b)
    assert not ra_concat_rb._model_vsa._reversed
