 ...
 * \ingroup unittest
 */
#ifndef R_UNIT_CREATE_BINARY_HPP_
#define R_UNIT_CREATE_BINARY_HPP_
...
template <typename Out, typename In, typename OpT, SM Mode, auto CreateF> inline void binary() {
    static_assert(Util::Type::is_ancestor<Expr::Base, Out>, "binary requires Out be an Expr");
    static_assert(Util::Type::is_ancestor<Expr::Base, In>, "binary requires In be an Expr");
