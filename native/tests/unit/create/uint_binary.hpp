...
inline void uint_binary() {
    static_assert(Util::is_ancestor<Expr::Base, Out>, "uint_binary requires Out be an Expr");
    static_assert(Util::is_ancestor<Expr::Base, In>, "uint_binary requires In be an Expr");
