...
namespace Utils {
    ...
    /** A dynamic down cast */
    template <typename Out, typename In>
    constexpr inline auto dynamic_down_cast(const In in) noexcept {
    ...
    template <typename Out, typename In>
    constexpr inline auto dynamic_down_cast_throw_on_fail(const In in) noexcept {
    ...
    template <typename Out, typename In>
    constexpr inline auto dynamic_side_cast_throw_on_fail(const In in) noexcept {
     ...
     */
    template <typename Out, typename In>
    constexpr inline auto static_down_cast(const In in)
#ifdef DEBUG
    {
     ...
     */
    template <typename Out, typename In>
    constexpr inline auto static_side_cast(const In in)
#ifdef DEBUG
    {
