...
namespace Backend::Z3 {
    ...
    /** Used to dispatch conversions and abstractions between Claricpp expressions and Z3 ASTs */
    template <typename Z3> struct Dispatch final {
         ...
         */
        static z3::expr dispatch_conversion(const Expression::RawPtr expr,
...
#define TO_BV_CASE(TF)                                                                            \
    case Op::FP::ToBV<TF>::static_cuid: {                                                         \
        ...
        auto ret { Conv::FP::template to_bv<TF>(                                                  \
            ...
            Expression::get_bit_length(expr)) };                                                  \
        args.pop_back();                                                                          \
        return ret;                                                                               \
    }
...
#define ASSERT_ARG_EMPTY(X)                                                                       \
    Utils::affirm<Utils::Error::Unexpected::Size>((X).empty(), WHOAMI_WITH_SOURCE                 \
            ...
            switch (decl_kind) {
                ...
                case Z3_OP_IFF:
                    return Abs::template eq<Ex::Bool>(args);
                case Z3_OP_XOR:
                ...
                case Z3_OP_NOT:
                    ...
                    // Comparisons
                case Z3_OP_ULEQ:
                    return Abs::template compare<Ex::BV, C::Unsigned | C::Less | C::Eq>(args);
                case Z3_OP_SLEQ:
                    return Abs::template compare<Ex::BV, C::Signed | C::Less | C::Eq>(args);
                case Z3_OP_UGEQ:
                    return Abs::template compare<Ex::BV, C::Unsigned | C::Greater | C::Eq>(args);
                case Z3_OP_SGEQ:
                    return Abs::template compare<Ex::BV, C::Signed | C::Greater | C::Eq>(args);
                case Z3_OP_ULT:
                    return Abs::template compare<Ex::BV, C::Unsigned | C::Less | C::Neq>(args);
                case Z3_OP_SLT:
                    return Abs::template compare<Ex::BV, C::Signed | C::Less | C::Neq>(args);
                case Z3_OP_UGT:
                    return Abs::template compare<Ex::BV, C::Unsigned | C::Greater | C::Neq>(args);
                case Z3_OP_SGT:
                    return Abs::template compare<Ex::BV, C::Signed | C::Greater | C::Neq>(args);
                ...
                case Z3_OP_FPA_NAN:
                    ...
                    // FP Comparisons
                case Z3_OP_FPA_EQ:
                    return Abs::template eq<Ex::FP>(args);
                case Z3_OP_FPA_GT:
                    return Abs::template compare<Ex::FP, C::Signed | C::Greater | C::Neq>(args);
                case Z3_OP_FPA_GE:
                    return Abs::template compare<Ex::FP, C::Signed | C::Greater | C::Eq>(args);
                case Z3_OP_FPA_LT:
                    return Abs::template compare<Ex::FP, C::Signed | C::Less | C::Neq>(args);
                case Z3_OP_FPA_LE:
                    return Abs::template compare<Ex::FP, C::Signed | C::Less | C::Eq>(args);
...
#undef G_CASE
                ...
                case Z3_OP_INTERNAL: {
                    Utils::affirm<Error::Backend::Abstraction>(
                        string_check(b_obj),
                        WHOAMI_WITH_SOURCE "b_obj is not a string as expected");
