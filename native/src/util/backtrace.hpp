 ...
 */
#ifndef R_UTIL_BACKTRACE_HPP_
#define R_UTIL_BACKTRACE_HPP_
...
namespace Util {
    ...
    inline void backtrace(std::ostream &o, const UInt ignore_frames = 0,
        ...
        try {
            ...
            Util::affirm<Err::Unknown>(n_frames > 0, WHOAMI_WITH_SOURCE "backtrace failed");
            ...
            for (UInt i { ignore_frames + 1 }; i < n_to_print; ++i) {      // util widen
