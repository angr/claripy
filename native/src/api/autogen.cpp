...
;
	...
	{ // Mode::FP::Width file: line:17
		...
		cl.def("__hash__", (long long (Mode::FP::Width::*)() const) &Mode::FP::Width::__hash__, "Signed 64-bit hash function \n\nC++: Mode::FP::Width::__hash__() const --> long long");
		...
		cl.def("__str__", [](Mode::FP::Width const &o) -> std::string { std::ostringstream s; Mode::FP::operator<<(s, o); return s.str(); } );
	}
}
...
void bind_unknown_unknown_7(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // BigInt file: line:17
		...
		cl.def("__str__", [](BigInt const &o) -> std::string { std::ostringstream s; operator<<(s, o); return s.str(); } );
	}
}
...
void bind_unknown_unknown_8(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// Hash::serialize(const class std::shared_ptr<const class Expr::Base> &) file: line:200
	...
	// Hash::serialize(const class std::shared_ptr<const class Op::Base> &) file: line:200
	...
	// Hash::serialize(const class std::shared_ptr<const class PyObj::VS> &) file: line:200
...
void bind_unknown_unknown_20(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Op::FP::Sqrt file: line:15
		pybind11::class_<Op::FP::Sqrt, std::shared_ptr<Op::FP::Sqrt>, Op::Base> cl(M("Op::FP"), "Sqrt", "The op class: sqrt ");
		cl.def_readonly("mode", &Op::FP::Sqrt::mode);
		cl.def_readonly("fp", &Op::FP::Sqrt::fp);
		cl.def("python_children", (class std::vector<class std::variant<bool, std::string, float, double, class std::shared_ptr<const class PyObj::VS>, unsigned char, unsigned short, unsigned int, unsigned long long, struct BigInt, class std::shared_ptr<const class Expr::Base>, enum Mode::FP::Rounding, struct Mode::FP::Width> > (Op::FP::Sqrt::*)() const) &Op::FP::Sqrt::python_children, "Appends the expr children of the expr to the given vector\n  Note: This should only be used when returning children to python\n\nC++: Op::FP::Sqrt::python_children() const --> class std::vector<class std::variant<bool, std::string, float, double, class std::shared_ptr<const class PyObj::VS>, unsigned char, unsigned short, unsigned int, unsigned long long, struct BigInt, class std::shared_ptr<const class Expr::Base>, enum Mode::FP::Rounding, struct Mode::FP::Width> >");
	}
}
...
void bind_unknown_unknown_28(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// Create::FP::sqrt(const enum Mode::FP::Rounding, const class std::shared_ptr<const class Expr::Base> &, class std::optional<class pybind11::dict>) file: line:16
	M("Create::FP").def("sqrt", [](const enum Mode::FP::Rounding & a0, const class std::shared_ptr<const class Expr::Base> & a1) -> std::shared_ptr<const class Expr::Base> { return Create::FP::sqrt(a0, a1); }, "", pybind11::arg("mode"), pybind11::arg("fp"));
	M("Create::FP").def("sqrt", (class std::shared_ptr<const class Expr::Base> (*)(const enum Mode::FP::Rounding, const class std::shared_ptr<const class Expr::Base> &, class std::optional<class pybind11::dict>)) &Create::FP::sqrt, "Create an Expr with a Sqrt op\n  Expr pointers may not be nullptr\n\nC++: Create::FP::sqrt(const enum Mode::FP::Rounding, const class std::shared_ptr<const class Expr::Base> &, class std::optional<class pybind11::dict>) --> class std::shared_ptr<const class Expr::Base>", pybind11::arg("mode"), pybind11::arg("fp"), pybind11::arg("d"));
...
void bind_unknown_unknown_29(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// Create::literal_bool(bool, class std::optional<class pybind11::dict>) file: line:95
	...
	// Create::literal_vs(class std::shared_ptr<const class PyObj::VS>, class std::optional<class pybind11::dict>) file: line:96
	...
	// Create::literal_string(std::string, class std::optional<class pybind11::dict>) file: line:97
...
{
	// Create::String::from_int(const class std::shared_ptr<const class Expr::Base> &, class std::optional<class pybind11::dict>) file: line:21
...
{
	// Create::String::sub_string(const class std::shared_ptr<const class Expr::Base> &, const class std::shared_ptr<const class Expr::Base> &, const class std::shared_ptr<const class Expr::Base> &, class std::optional<class pybind11::dict>) file: line:45
...
void bind_unknown_unknown_33(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// Create::symbol_fp(std::string, const unsigned long long, class std::optional<class pybind11::dict>) file: line:146
	...
	// Create::symbol_vs(std::string, const unsigned long long, class std::optional<class pybind11::dict>) file: line:147
...
void bind_unknown_unknown_37(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Backend::Z3::Solver file: line:13
		...
		cl.def("__str__", [](Backend::Z3::Solver const &o) -> std::string { std::ostringstream s; Backend::Z3::operator<<(s, o); return s.str(); } );
	}
}
...
void bind_unknown_unknown_38(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Backend::Z3::Z3 file: line:25
		...
		cl.def_static("set_main", (void (*)()) &Backend::Z3::Z3::set_main, "Define this thread as the main thread\n  This should only be called once\n\nC++: Backend::Z3::Z3::set_main() --> void");
		cl.def("interrupt", (void (Backend::Z3::Z3::*)()) &Backend::Z3::Z3::interrupt, "Interrupt this thread's z3 context \n\nC++: Backend::Z3::Z3::interrupt() --> void");
		cl.def("clone", (class Backend::Z3::Solver (Backend::Z3::Z3::*)(const class Backend::Z3::Solver &)) &Backend::Z3::Z3::clone, "Clone the given solver \n\nC++: Backend::Z3::Z3::clone(const class Backend::Z3::Solver &) --> class Backend::Z3::Solver", pybind11::arg("s"));
...
PYBIND11_MODULE(clari, root_module) {
	...
	API::Binder::bind_std_exception(M);
...
// Source list file: /output/clari.sources
// clari.cpp
// std/exception.cpp
// unknown/unknown.cpp
...
// Modules list file: /output/clari.modules
// Backend Backend.Z3 CUID Create Create.FP Create.String Expr Factory Hash Hash.Private Mode Mode.FP Mode.Sign Op Op.FP Op.String PyObj Util Util.Backtrace Util.Err std