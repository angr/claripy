 ...
 * @return The repr of expr as a dynamically allocated C string
 */
 ...
 * @return The name of the type of expr as a statically allocated C string
 */
 ...
 * @return The name of the op in expr as a statically allocated C string
 */
