...
namespace Expression {
     ...
     * consumed. This function takes in move references for everything; it has no const promises,
     *  it may consume anything that is passed to it. This factory handles hashing and
     *  returns an Expression::Base (a shared pointer to the constructed object)
