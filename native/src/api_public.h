 ...
 *  @param from The Expression to be extracted from
 *  @param spav A ClaricppSPAV; spav.ptr may be nullptr
 */
 ...
 *  @param left The 'if true' expression in the if then else statement
 *  @param left The 'if false' expression in the if then else statement
 *  @param spav A ClaricppSPAV; spav.ptr may be nullptr
 */
