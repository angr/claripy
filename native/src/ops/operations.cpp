...
const OpSet Ops::Expression::operations =
    Utils::set_join<Operations>(Ops::Expression::arithmetic, Ops::Expression::comparator,
...
const OpSet Ops::Backend::operations = Utils::set_join<Operations>(
    Ops::Backend::comparator, Ops::Backend::bitwise, Ops::Backend::boolean,
    Ops::Backend::bitmod, Ops::Backend::creation, Ops::Backend::other,
    Ops::Backend::arithmetic);

const OpSet Ops::Backend::operations_vsa_compliant =
    Utils::set_join<Operations>(Ops::Backend::bitwise, Ops::Backend::comparator,
                                Ops::Backend::boolean, Ops::Backend::bitmod);

const OpSet Ops::Backend::operations_all = Utils::set_join<Operations>(
    Ops::Backend::operations, Ops::Backend::operations_vsa_compliant,
...
const OpSet Ops::Length::none =
    Utils::set_join<Operations>(Ops::Backend::comparator, Ops::Expression::comparator,
