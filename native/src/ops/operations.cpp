...
const OpSet Ops::Expression::bitwise {
    OP::__invert__,  OP::__or__,     OP::__ror__,     OP::__and__,
    OP::__rand__,    OP::__xor__,    OP::__rxor__,    OP::__lshift__,
    OP::__rlshift__, OP::__rshift__, OP::__rrshift__,
};
...
const OpSet Ops::Backend::vsa_creation { OP::TopStridedInterval, OP::StridedInterval,
                                         OP::ValueSet, OP::AbstractLocation };

const OpSet Ops::Backend::other { OP::If };

const OpSet Ops::Backend::arithmetic { OP::SDiv, OP::SMod };

const OpSet Ops::Backend::operations =
    Utils::set_join(Ops::Backend::comparator, Ops::Backend::bitwise,
                    Ops::Backend::boolean, Ops::Backend::bitmod, Ops::Backend::creation,
                    Ops::Backend::other, Ops::Backend::arithmetic);

const OpSet Ops::Backend::operations_vsa_compliant =
    Utils::set_join(Ops::Backend::bitwise, Ops::Backend::comparator,
                    Ops::Backend::boolean, Ops::Backend::bitmod);

const OpSet Ops::Backend::operations_all =
    Utils::set_join(Ops::Backend::operations, Ops::Backend::operations_vsa_compliant,
...
const OpSet Ops::Backend::fp = Utils::set_join(
    OpSet { OP::FPS, OP::fpToFP, OP::fpToIEEEBV, OP::fpFP, OP::fpToSBV, OP::fpToUBV,
            OP::fpNeg, OP::fpSub, OP::fpAdd, OP::fpMul, OP::fpDiv, OP::fpAbs },
    Ops::Backend::fp_cmp);
...
const OpSet Ops::Length::same = Utils::set_join(
    Ops::Expression::arithmetic, Ops::Expression::bitwise, Ops::Expression::set,
    Ops::Backend::bitwise, Ops::Backend::other, OpSet { OP::Reversed });

const OpSet Ops::Length::none =
    Utils::set_join(Ops::Backend::comparator, Ops::Expression::comparator,
                    Ops::Backend::boolean, Ops::Backend::fp_cmp);
...
const std::map<OP, const char *const> Ops::infix {
    ...
    { OP::__floordiv__, "/" },
    { OP::__truediv__,
      "/" }, // the raw / operator should use integral semantics on bitvectors
    { OP::__pow__, "**" },
    { OP::__mod__, "%" },
    { OP::__eq__, "==" },
    { OP::__ne__, "!=" },
