...
class ClaripyStandalone(Claripy):
    def __init__(self, model_backends=None, solver_backends=None, parallel=False):
        ...
        Claripy.__init__(self, model_backends, solver_backends, datalayer, parallel=parallel)
